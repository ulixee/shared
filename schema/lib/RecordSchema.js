...
class RecordSchema extends BaseSchema_1.default {
    constructor(config) {
        ...
        assert(config.values instanceof BaseSchema_1.default, 'The values definition for this record must be a type of Schema');
        if (config.keys) {
            assert(config.keys instanceof StringSchema_1.default, 'The definition for keys of this record must be a StringSchema');
        }
    }
