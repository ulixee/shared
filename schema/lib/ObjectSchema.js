...
class ObjectSchema extends BaseSchema_1.default {
    constructor(config) {
        ...
        assert(Object.keys(config.fields).length, 'You must configure one or more fields for this object');
        assert(Object.values(config.fields).every(x => x && x instanceof BaseSchema_1.default), 'Each value of fields must be a type of Schema');
    }
